          ...
          <ul class="nav-main">
            ...
            <li class="nav-main-item{{ request()->is('pages/*') ? ' open' : '' }}">
              <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                ...
                <span class="nav-main-link-name">Data Base</span>
              </a>
              <ul class="nav-main-submenu">
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link{{ request()->is('pages/datakendaraan') ? ' active' : '' }}" href="/pages/datakendaraan">
                      <span class="nav-main-link-name">Data Kendaraan</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link{{ request()->is('pages/riwayattransaksi') ? ' active' : '' }}" href="/pages/riwayattransaksi">
                      <span class="nav-main-link-name">Riwayat Transaksi</span>
                    </a>
                  </li>
                <li class="nav-main-item">
